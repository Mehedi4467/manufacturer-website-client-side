...
const SingleOrder = ({ setOpenModal, order, index }) => {
    ...
    return (
        <tr>
            ...
            {
                (totalPrice && !order.paid) ? <td><Link to={`/dashboard/payment/${order._id}`}><button className='btn btn-sm bg-orange-500'>Pay Now</button></Link></td> : <p className='text-orange-500 p-4'>Paid</p>
